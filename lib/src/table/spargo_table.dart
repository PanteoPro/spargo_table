              ...
              builder: (context, heightRow, _) {
                return Container(
                  decoration: BoxDecoration(
                      ...
                      borderRadius:
                          widget.decorationConfiguration.tableBorderRadius),
                  child: Scrollbar(
                          ...
                          builder: (context, maxHeight, _) {
                            return ValueListenableBuilder(
                                ...
                                builder:
                                  ...
                                  return ValueListenableBuilder(
                                      valueListenable:
                                          vm.heightSubWidgetNotifier,
                                      builder:
                                          (context, addedHeightBySubWidget, _) {
                                        return ValueListenableBuilder(
                                            valueListenable:
                                                vm.columnWidthsNotifier,
                                            builder:
                                                (context, columnWidths, _) {
                                              if (!listEquals(
                                                  vm.currentColumnWidths,
                                                  columnWidths)) {
                                              ...
                                              final heightSubWidget = widget
                                                              .selectedRow !=
                                                          null &&
                                                      widget.selectedRowSubWidgetBuilder !=
                                                          null
                                                  ? widget.maxHeightSubWidget ??
                                                            ...
                                                            builder: (context,
                                                              ...
                                                              return ValueListenableBuilder(
                                                                  ...
                                                                  builder: (context,
                                                                      sortedData,
                                                                      _) {
                                                                    final dataForRender = sortedData ??
                                                                        filteredData ??
                                                                        widget
                                                                            .data;
...
class _ContentWidgetState<T> extends State<_ContentWidget<T>> {
  ...
  Color? getColor(int adjustedIndex) {
    return (widget.getIsRowMarked != null &&
            widget.getIsRowMarked!(widget.dataForRender[adjustedIndex]))
        ...
        if (widget.dataForRender.isNotEmpty)
          Offstage(
            child: SpargoTableRowWidget(
              ...
              buildRow: () =>
                  widget.configuration.buildRow(widget.dataForRender[0]),
              colorRow: null,
              ...
              child: Padding(
                padding: EdgeInsets.only(
                    bottom: widget.isDisplayedHorizontalScroll
                        ? widget
                            .decorationConfiguration.bottomPaddingForScrollbar
                        : 0),
                        ...
                        (context, index) {
                          ...
                          return SpargoTableRowWidget(
                            ...
                            isSelected: widget.selectedRow ==
                                widget.dataForRender[index],
                            onRowTap: widget.onRowTap != null
                                ? () => widget
                                    .onRowTap!(widget.dataForRender[index])
                                : null,
                            columns: widget.configuration.columns,
                            columnWidths: widget.columnWidths,
                            buildRow: () => widget.configuration
                                .buildRow(widget.dataForRender[index]),
                            colorRow: colorRow,
                            border: widget.decorationConfiguration.borderRow,
                            selectedRowColor:
                                widget.decorationConfiguration.selectedRowColor,
                          );
                        },
                        childCount: widget.selectedRowIndex != null &&
                      ...
                      if (widget.selectedRowIndex != itemsCount - 1)
                        SliverFixedExtentList(
                          ...
                          delegate: SliverChildBuilderDelegate(
                            (context, index) {
                              final adjustedIndex =
                                  index + (widget.selectedRowIndex! + 1);
                              final colorRow = getColor(adjustedIndex);

                              return SpargoTableRowWidget(
                                key: Key('row_$adjustedIndex'),
                                isSelected: widget.selectedRow ==
                                    widget.dataForRender[adjustedIndex],
                                onRowTap: widget.onRowTap != null
                                    ? () => widget.onRowTap!(
                                        widget.dataForRender[adjustedIndex])
                                    : null,
                                columns: widget.configuration.columns,
                                columnWidths: widget.columnWidths,
                                buildRow: () => widget.configuration.buildRow(
                                    widget.dataForRender[adjustedIndex]),
                                colorRow: colorRow,
                                border:
                                    widget.decorationConfiguration.borderRow,
                                selectedRowColor: widget
                                    .decorationConfiguration.selectedRowColor,
                              );
                            },
                            childCount:
                                itemsCount - (widget.selectedRowIndex! + 1),
                          ),
                        ),
                    ],
                  ],
